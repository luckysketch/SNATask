...
public class ThirdFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        functionContainer=new FunctionContainer(2);
        lock_btn=view.findViewById(R.id.frg3_lock);
        ...
        btn1=view.findViewById(R.id.frg3_btn1);
        ...
        btn2=view.findViewById(R.id.frg3_btn2);
        ...
        btn3=view.findViewById(R.id.frg3_btn3);
        ...
        btn4=view.findViewById(R.id.frg3_btn4);
        ...
        btn5=view.findViewById(R.id.frg3_btn5);
        ...
        btn6=view.findViewById(R.id.frg3_btn6);
        ...
        btn7=view.findViewById(R.id.frg3_btn7);
        ...
        btn8=view.findViewById(R.id.frg3_btn8);
        ...
        relativeLayout=view.findViewById(R.id.device2);
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(getActivity(),Device.class);
                intent.putExtra("device_no",2);
